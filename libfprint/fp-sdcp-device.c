...
fp_sdcp_device_open (FpDevice *device)
{
  ...
  /* Try a reconnect if we still have a private key. */
  if (priv->pk_h)
...
#if 0
  fp_device_class->enroll = fp_sdcp_device_start_capture_action;
  fp_device_class->verify = fp_sdcp_device_start_capture_action;
  fp_device_class->identify = fp_sdcp_device_start_capture_action;
  fp_device_class->capture = fp_sdcp_device_start_capture_action;
